...
- (instancetype)initWithCollectionViewLayout:(UICollectionViewLayout *)layout {
    ...
    if (self) {
        ...
        // Register cell class
        [self.collectionView registerClass:[QBAssetsCollectionViewCell class] forCellWithReuseIdentifier:@"AssetsCell"];
        [self.collectionView registerClass:[QBAssetsCollectionFooterView class] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"FooterView"];
...
- (void)setFilterType:(QBImagePickerControllerFilterType)filterType {
    ...
    // Set assets filter
    [self.assetsGroup setAssetsFilter:ALAssetsFilterFromQBImagePickerControllerFilterType(_filterType)];
